      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            ...
            <ul className="space-y-2 text-center md:text-left">
              <li>
                <Link href="/servicios" className="text-[#daf3f3] hover:text-white transition-colors text-sm">
                  Servicios
                </Link>
              </li>
              <li>
                <Link href="/portafolio" className="text-[#daf3f3] hover:text-white transition-colors text-sm">
                  Portafolio
                </Link>
              </li>
              <li>
                <Link href="/nosotros" className="text-[#daf3f3] hover:text-white transition-colors text-sm">
                  Nosotros
                </Link>
              </li>
              <li>
                <Link href="/blog" className="text-[#daf3f3] hover:text-white transition-colors text-sm">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/contacto" className="text-[#daf3f3] hover:text-white transition-colors text-sm">
                  Contacto
                </Link>
              </li>
            </ul>
        ...
        >
          <p className="text-xs text-[#daf3f3]">
            © {new Date().getFullYear()} HanaByte 花. Todos los derechos reservados.
          </p>
        </motion.div>
      </div>
    </footer>
